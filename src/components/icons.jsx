...
export function LeafIcon({ className = "h-5 w-5" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden="true">
      <path d="M4 20c8 0 16-4 16-14-10 0-16 4-16 14Z" strokeLinejoin="round" />
      <path d="M8 16c3-4 6-7 10-9" strokeLinecap="round" />
    </svg>
  )
}
...
export function HeartIcon({ className = "h-5 w-5" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className} aria-hidden="true">
      <path d="M12 20s-7-4.5-9.5-9A5.2 5.2 0 0 1 12 6.5 5.2 5.2 0 0 1 21.5 11c-2.5 4.5-9.5 9-9.5 9Z" strokeLinejoin="round" />
    </svg>
  )
}
